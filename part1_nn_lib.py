...
# Custom implemented xavier initialization
...
class LinearLayer(Layer):
    ...
    def __init__(self, n_in, n_out):
        ...
        # Initialize weight using Xavier and bias to zero
    ...
    def forward(self, x):
        ...
        # Cache current input for use in backward pass
        self._cache_current = x
    ...
    def backward(self, grad_z):
        ...
        # Compute gradients of loss and bias
    ...
    def update_params(self, learning_rate):
        ...
        # Update weights and bias using cumputed gradients
...
class IdentityLayer(Layer):
    """
    IdentityLayer: Applies the identity function elementwise.
    """
...
class MultiLayerNetwork(object):
    ...
    def __init__(self, input_dim, neurons, activations):
        ...
        for i in range(len(neurons)):
            self._layers.append(LinearLayer(input_dim if i == 0 else neurons[i - 1], neurons[i]))
...
class Trainer(object):
    ...
    def shuffle(input_dataset, target_dataset):
        ...
        """
        # Shuffles indices to preserve correspondence
    ...
    def train(self, input_dataset, target_dataset):
        ...
        for epoch in range(self.nb_epoch):
            ...
            batch_input = None
            batch_target = None
            # Loops through input_dataset in batch size increments
            for i in range(0, input_dataset.shape[0], self.batch_size):
                ...
                pred = self.network.forward(batch_input)
                loss = self._loss_layer.forward(pred, batch_target)
...
class Preprocessor(object):
    ...
    def __init__(self, data):
        ...
        Arguments:
            ...
            the normalization.
        """
        self.min = np.min(data, axis = 0) # Stores minimum value for each column
        self.max = np.max(data, axis = 0) # Stores maximum value for each column
    ...
    def apply(self, data):
        ...
        """
        # Applies min-max scaling equation to input data and returns preprocessed data
    ...
    def revert(self, data):
        ...
        """
        # Reverses min-max scaling operation to data and returns original data
        reverted_data = (data * (self.max - self.min)) + self.min
